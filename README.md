...
**Фронтенд проекта:** [d_fr](https://github.com/ART20230129/d_fr)
...
### Основные эндпойнты
#### Аутентификация
|Метод   | Путь            | Тело запроса             |  Статус-коды     |
|--------|-----------------|--------------------------|------------------|
|POST    |/api/v1/register/|{                         |  201 - Создано   |
|        |                 |"username": login,        |  400 - неверный  |
|        |                 |"last_name": fullName,    |        запрос    |
|        |                 |"email": email,           |                  |
|        |                 |"password": password      |                  |
|        |                 |}                         |                  |
|--------|-----------------|--------------------------|------------------|
|POST    |/api/v1/login/   |{                         |  200 - Успех     |
|        |                 |"username": form.login,   |  500 - ошибка    |
|        |                 |"password": form.password,|        сервера   |
|        |                 |}                         |                  |
|--------|-----------------|--------------------------|------------------|
|POST    |/api/v1/logout/  |                          |  200 - Успех     |
|        |                 |                          |  500 - ошибка    |
|        |                 |                          |        сервера   |
|--------|-----------------|--------------------------|------------------|
...
|Метод   | Путь            | Тело запроса             |  Статус-коды     |
|--------|-----------------|--------------------------|------------------|
|GET     |/api/v1/allusers/|                          |  200 - Успех     |
|        |                 |                          |  500 - ошибка    |
|        |                 |                          |        сервера   |
|        |                 |                          |                  |
|--------|-----------------|--------------------------|------------------|
|PATCH   |/api/v1/users/{id}/|{                         |  200 - Успех     |
|        |                   |is_staff: !is_staff       |  500 - ошибка    |
|        |                   |}                         |        сервера   |
|--------|-------------------|--------------------------|------------------|
|DELETE  |/api/v1/users/{id}/|                          |  200 - Успех     |
|        |                   |                          |  500 - ошибка    |
|        |                   |                          |        сервера   |
|--------|-------------------|--------------------------|------------------|
|GET     |/api/v1/uploadfileuser/{id_user}/|                          |  200 - Успех     |
|        |                                 |                          |  500 - ошибка    |
|        |                                 |                          |        сервера   |
|--------|---------------------------------|--------------------------|------------------|
...
|Метод   | Путь              | Тело запроса             |  Статус-коды     |
|--------|-------------------|--------------------------|------------------|
|GET     |api/v1/uploadfile/ |                          |  200 - Успех     |
|        |                   |                          |  500 - ошибка    |
|        |                   |                          |        сервера   |
|--------|-------------------|--------------------------|------------------|
|POST    |api/v1/uploadfile/ |{                         |  200 - Успех     |
|        |                   |'file', selectedFile,     |  500 - ошибка    |
|        |                   |'comments', userComments, |        сервера   |
|        |                   |'user_id', user_id        |                  |
|        |                   |}                         |                  |
|--------|-------------------|--------------------------|------------------|
|POST    |api/v1/uploadfile/ |{                         |  200 - Успех     |
...
|        |                   |}                         |                  |
|--------|-------------------|--------------------------|------------------|
|DELETE  |api/v1/files/{id}  |                          |  200 - Успех     |
|        |                   |                          |  500 - ошибка    |
|        |                   |                          |        сервера   |
|--------|-------------------|--------------------------|------------------|
|PATCH   |api/v1/files/{id}  |{                         |  200 - Успех     |
|        |                   |file_name: newNameFile,   |  500 - ошибка    |
|        |                   |comments: newComment      |        сервера   |
|        |                   |}                         |                  |
|--------|-------------------|--------------------------|------------------|
|GET     |/api/v1/downloadfile/{id_file}/|                          |  200 - Успех     |
|        |                               |                          |  500 - ошибка    |
|        |                               |                          |        сервера   |
|        |                               |                          |                  |
|--------|-------------------------------|--------------------------|------------------|
|POST    |/api/v1/downloadlinkfile/{id_file}/|                          |  200 - Успех     |
|        |                                   |                          |  500 - ошибка    |
|        |                                   |                          |        сервера   |
|        |                                   |                          |                  |
|--------|-----------------------------------|--------------------------|------------------|
